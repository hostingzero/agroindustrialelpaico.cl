...
class QuoteListController {
	...
	public static function init() {
		...
		if ( ( ( in_array( 'elementor/elementor.php', $activated_plugins ) || array_key_exists( 'elementor/elementor.php', $activated_plugins ) ) ) && ( 'Twenty Twenty-Three' === $theme->name || 'Twenty Twenty-Two' === $theme->name )) {
