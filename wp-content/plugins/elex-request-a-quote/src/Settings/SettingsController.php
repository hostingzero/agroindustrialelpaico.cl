...
class SettingsController {
	...
	public static function load_hide_cart() {
		...
		include VIEW_PATH . 'settings/hide_addtocart_price.php';
		self::show_saved_toast();
	...
	public static function save_general( GeneralSettings $general_setting_options ) {
		...
		$new_settings['general']['add_to_quote_success_message']                = isset( $_POST['general']['add_to_quote_success_message'] ) && ! empty( $_POST['general']['add_to_quote_success_message'] ) ? sanitize_text_field( $_POST['general']['add_to_quote_success_message'] ) : esc_html__( 'Product successfully added to the Quote List', 'elex_request_a_quote' );
		$new_settings['general']['button_label']                                = isset( $_POST['general']['button_label'] ) ? sanitize_text_field( $_POST['general']['button_label'] ) : 'Add to Quote';
		...
		$new_settings['general']['include_exclude_based_on_stock'] =  esc_html__( 'show_for_all_products' , 'elex_request_a_quote' );
	...
	public static function load_view() {
		...
		include VIEW_PATH . 'settings.php';
	}
	...
	public static function get_menus() {
		...
		$setting_menus = array(
			...
			array(
				'title' => __( 'Hide Add to Cart & Price' ),
				'slug'  => 'hide_cart',
