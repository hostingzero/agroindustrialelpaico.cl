...
class FormSettings {
	...
	public static function get_default_form_data() {
		...
		$defaults = array(
			...
			'success_message' => __( 'Your request has been submitted.' , 'elex_request_a_quote' ),
			'fields'          => 
					array( 
						array(
							'name'              => 'First Name',
							'slug'              => 'first_name',
							'type'              => 'text',
							'placeholder'       => __( 'Add your first name.', 'elex_request_a_quote' ),
						...
						array(
							...
							'slug'              => 'last_name',
							'type'              => 'text',
							'placeholder'       => __( 'Add your last name.' , 'elex_request_a_quote' ),
						...
						array(
							...
							'slug'              => 'email',
							'type'              => 'email',
							'placeholder'       => __( 'Add your email.' , 'elex_request_a_quote' ),
						...
						array(
							...
							'slug'              => 'phone',
							'type'              => 'tel',
							'placeholder'       => __( 'Enter your Phone number' , 'elex_request_a_quote' ),
