				...
				<div class="row mb-3">
					<div class="col-lg-4 col-md-6 ">
						<div class="d-flex justify-content-between align-items-center">
							...
							<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Select the WooCommerce page where you want to display the quote list.">
				...
				<div class="row ">
					<div class="col-lg-4 col-md-6 ">
						<div class="d-flex justify-content-between align-items-center">
							...
							<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Enter the title on the quote list page.">
				...
				<div class="row align-items-center mb-3">
					<div class="col-lg-4 col-md-6">
						<div class="d-flex justify-content-between align-items-center">
							...
							<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Turn On or Off if you want to show or hide the ELEXtensions watermark on the quote list page.
">
