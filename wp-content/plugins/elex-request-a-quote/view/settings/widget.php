					...
					<div class="row align-items-center">
						<div class="col-lg-4 col-md-6 mb-3 ">
							<div class="d-flex justify-content-between align-items-center">
								...
								<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Select the color of the widget when a customer hovers over it.">
					...
					<div class="row align-items-center mb-3">
						<div class="col-lg-4 col-md-6">
							<div class="d-flex justify-content-between align-items-center">
								...
								<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="You may face compatibility issues with specific themes when Fixed icon type is chosen.">
									<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26">
										<g id="tt" transform="translate(-384 -226)">
											<g id="Ellipse_1" data-name="Ellipse 1" transform="translate(384 226)" fill="#f5f5f5" stroke="#000" stroke-width="1">
												<circle cx="13" cy="13" r="13" stroke="none"></circle>
								...
								<div class="row align-items-center mb-3 elex-button-label-quote-icon">
									<div class="col-lg-4 col-md-6  ">
										<div class="d-flex justify-content-between align-items-center">
											...
											<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Please enter the text that you would like to display as a button label.">
									...
									<div class="col-lg-4 col-md-6 mb-3 ">
										<input  name="button_label" type="text " value="<?php echo esc_html_e( isset( $settings['button_label'] ) ? $settings['button_label'] : '' ); ?>" class="form-control " placeholder="Quote List">
									</div>
					...
					<div class="row align-items-center mb-3">
						<div class="col-lg-4 col-md-6">
							<div class="d-flex justify-content-between align-items-center">
								...
								<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Turn it on or off if you want to display or hide the list of products in the quote list by hovering over the quote list widget.">
