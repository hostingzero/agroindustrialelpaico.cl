					...
					<div class="row ">
						...
						<div class=" col-lg-8 col-md-6 ">
							<div class="">
								...
								<div class="text-secondary ">
									<small><?php esc_html_e('Turn on hide add to cart button on shop page', 'elex-request-a-quote'); ?></small>
								</div>
							</div>
					...
					<div class="row ">
						...
						<div class=" col-lg-8 col-md-6 ">
							<div class="">
								...
								<div class="text-secondary ">
									<small><?php esc_html_e('Turn on hide add to cart button on product page.', 'elex-request-a-quote'); ?></small>
								</div>
							</div>
						...
						<div class="row mb-3 align-items-center">
							<div class=" col-lg-4 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									...
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Select the product categories that you want to exclude from the above applied settings">
						...
						<div class="row mb-3 align-items-center">
							<div class=" col-lg-4 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									...
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Select the product names that you want to exclude from the above applied settings">
						...
						<div class="row mb-3 align-items-center">
							<div class=" col-lg-4 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									...
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Select the product tags that you want to exclude from the above applied settings">
