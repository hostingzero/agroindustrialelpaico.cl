					...
					<div class="  elex-rqst-quote-email-template-container">
						...
						<div class=" position-relative elex-raq-basic-email-template d-flex flex-wrap gap-3 p-2 mb-3 overflow-auto">
							...
							<div class="elex-rqst-quote-email-template">
								...
								<div
									class="bg-dark bg-opacity-25 elex-rqst-email-template-preview position-fixed w-100 h-100 top-0 start-0  py-4">
									<div class="d-flex justify-content-center align-items-center w-100 h-100">
										<div class="position-relative overflow-auto h-100  "
											style="width:600px;padding:10px;background:#fff;">
											<button type="button"
												class=" btn position-absolute  bg-white rounded-pill p-0 ms-4 elex-rqst-email-preview-close-btn"><svg
													xmlns="http://www.w3.org/2000/svg" width="30" viewBox="0 0 512 512">
													<path fill="red"
														d="M175 175C184.4 165.7 199.6 165.7 208.1 175L255.1 222.1L303 175C312.4 165.7 327.6 165.7 336.1 175C346.3 184.4 346.3 199.6 336.1 208.1L289.9 255.1L336.1 303C346.3 312.4 346.3 327.6 336.1 336.1C327.6 346.3 312.4 346.3 303 336.1L255.1 289.9L208.1 336.1C199.6 346.3 184.4 346.3 175 336.1C165.7 327.6 165.7 312.4 175 303L222.1 255.1L175 208.1C165.7 199.6 165.7 184.4 175 175V175zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 48C141.1 48 48 141.1 48 256C48 370.9 141.1 464 256 464C370.9 464 464 370.9 464 256C464 141.1 370.9 48 256 48z" />
												</svg></button>
											<?php
									ob_start();
									require SRC_PATH . 'TemplateSetting/DefaultTemplates/squared_logo_template.php';
								...
								<div
									...
									<div class="d-flex justify-content-center align-items-center w-100 h-100">
										<div class="position-relative overflow-auto h-100  "
											...
											<?php
												ob_start();
												require SRC_PATH . 'TemplateSetting/DefaultTemplates/rectangle_logo_template.php';
												$content = ob_get_clean();
												echo wp_kses_post( $content );
											?>
								...
								<div
									...
									<div class="d-flex justify-content-center align-items-center w-100 h-100">
										<div class="position-relative overflow-auto h-100  "
											...
											<?php
									ob_start();
									require SRC_PATH . 'TemplateSetting/DefaultTemplates/non_logo_template.php';
									$content = ob_get_clean();
									echo wp_kses_post( $content );
											?>
											<!-- <img src="<?php echo esc_url( plugins_url( 'assets/images/temp 3@2x.png', dirname( __DIR__ ) ) ); ?>" alt="" class="w-100"> -->
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row mb-3 align-items-center">
							<div class=" col-lg-5 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									...
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top"
										title="Enter the subject for the email sent to the administrator when a quote is received.">
						...
						<div class="row mb-3 align-items-center">
							<div class=" col-lg-5 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									...
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top"
										title="Enter the heading for the email sent to the administrator when a quote is received.">
						...
						<div class="row mb-3 email-body ">
							<div class=" col-lg-5 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									...
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top"
										title="Enter the body for the email sent to the administrator when a quote is received.">
						...
						<div class="row mb-3 align-items-center">
							<div class=" col-lg-5 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									<h6 class="mb-0"><?php esc_html_e( 'Email Subject', 'elex-request-a-quote' ); ?></h6>
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top"
										title="Enter the subject for the email sent to the customer when a quote is requested.">
						...
						<div class="row mb-3 align-items-center">
							<div class=" col-lg-5 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									<h6 class="mb-0"><?php esc_html_e( 'Email Heading', 'elex-request-a-quote' ); ?></h6>
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top"
										title="Enter the heading for the email sent to the customer when a quote is requested.">
						...
						<div class="row mb-3 email-body ">
							<div class=" col-lg-5 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									<h6 class="mb-0"><?php esc_html_e( 'Email Body', 'elex-request-a-quote' ); ?></h6>
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top"
										title="Enter the body for the email sent to the customer when a quote is requested.">
						...
						<div class="row mb-3 align-items-center">
							<div class=" col-lg-5 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									<h6 class="mb-0"><?php esc_html_e( 'Email Subject', 'elex-request-a-quote' ); ?></h6>
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top"
										title="Enter the subject for the email sent to the customer when a quote is accepted by the administrator.">
						...
						<div class="row mb-3 align-items-center">
							<div class=" col-lg-5 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									<h6 class="mb-0"><?php esc_html_e( 'Email Heading', 'elex-request-a-quote' ); ?></h6>
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top"
										title=" Enter the heading for the email sent to the customer after the quote request is accepted by the administrator.">
						...
						<div class="row mb-3 email-body">
							<div class=" col-lg-5 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									<h6 class="mb-0"><?php esc_html_e( 'Email Body', 'elex-request-a-quote' ); ?></h6>
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top"
										title="Enter the body for the email sent to the customer after the quote request is accepted by the administrator.">
						...
						<div class="row mb-3 align-items-center">
							<div class=" col-lg-5 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									<h6 class="mb-0"><?php esc_html_e( 'Email Subject', 'elex-request-a-quote' ); ?></h6>
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top"
										title="Enter the subject for the email sent to the customer when a quote is rejected by the administrator.">
						...
						<div class="row mb-3 align-items-center">
							<div class=" col-lg-5 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									<h6 class="mb-0"><?php esc_html_e( 'Email Heading', 'elex-request-a-quote' ); ?></h6>
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top"
										title=" Enter the heading for the email sent to the customer after the quote request is rejected by the administrator.">
						...
						<div class="row mb-3 email-body">
							<div class=" col-lg-5 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									<h6 class="mb-0"><?php esc_html_e( 'Email Body', 'elex-request-a-quote' ); ?></h6>
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top"
										title="Enter the body for the email sent to the customer after the quote request is rejected by the administrator.">
						...
						<div class="row mb-3 align-items-center">
							<div class=" col-lg-5 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									...
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top"
										title="Enter the content for the SMS/google chat notification sent to the administrator on receiving a quote request. you can enter text or fill the fields dynamically using placeholders from the above table. HTML tags are not accepted in this field.">
						...
						<table class="table mb-2">
							...
							<tbody class="border-top-0">
								...
								<tr>
									...
									<td><?php esc_html_e( '@billing_first_name', 'elex-request-a-quote' ); ?></td>
								</tr>

								<tr>
									<td><?php esc_html_e( 'Billing Last Name', 'elex-request-a-quote' ); ?></td>
									<td><?php esc_html_e( '@billing_last_name', 'elex-request-a-quote' ); ?></td>
								</tr>

								<tr>
									<td><?php esc_html_e( 'Billing Company', 'elex-request-a-quote' ); ?></td>
									<td><?php esc_html_e( '@billing_company', 'elex-request-a-quote' ); ?></td>
								</tr>

								<tr>
									<td><?php esc_html_e( 'Billing Country', 'elex-request-a-quote' ); ?></td>
									<td><?php esc_html_e( '@billing_country', 'elex-request-a-quote' ); ?></td>
								</tr>
								<tr>
									<td><?php esc_html_e( 'Billing Address 1', 'elex-request-a-quote' ); ?></td>
									<td><?php esc_html_e( '@billing_address_1', 'elex-request-a-quote' ); ?></td>
								</tr>

								<tr>
									<td><?php esc_html_e( 'Billing Address 2', 'elex-request-a-quote' ); ?></td>
									<td><?php esc_html_e( '@billing_address_2', 'elex-request-a-quote' ); ?></td>
								</tr>
								<tr>
									<td><?php esc_html_e( 'Billing City', 'elex-request-a-quote' ); ?></td>
									<td><?php esc_html_e( '@billing_city', 'elex-request-a-quote' ); ?></td>
								</tr>
								<tr>
									<td><?php esc_html_e( 'Billing State', 'elex-request-a-quote' ); ?></td>
									<td><?php esc_html_e( '@billing_state', 'elex-request-a-quote' ); ?></td>
								</tr>
								<tr>
									<td><?php esc_html_e( 'Billing Postcode', 'elex-request-a-quote' ); ?></td>
									<td><?php esc_html_e( '@billing_postcode', 'elex-request-a-quote' ); ?></td>
								</tr>
								<tr>
									<td><?php esc_html_e( 'Billing Phone', 'elex-request-a-quote' ); ?></td>
									<td><?php esc_html_e( '@billing_phone', 'elex-request-a-quote' ); ?></td>
								</tr>
								<tr>
									<td><?php esc_html_e( 'Billing Email', 'elex-request-a-quote' ); ?></td>
									<td><?php esc_html_e( '@billing_email', 'elex-request-a-quote' ); ?></td>
								</tr>
								<tr>
									<td><?php esc_html_e( 'Order Items', 'elex-request-a-quote' ); ?></td>
									<td><?php esc_html_e( '@order_items', 'elex-request-a-quote' ); ?></td>
								</tr>
								<tr>
									<td><?php esc_html_e( 'Payment Link', 'elex-request-a-quote' ); ?></td>
									<td><?php esc_html_e( '@payment_link', 'elex-request-a-quote' ); ?></td>
								</tr>
								<tr>
									<td><?php esc_html_e( 'Customer Note', 'elex-request-a-quote' ); ?></td>
									<td><?php esc_html_e( '@customer_note', 'elex-request-a-quote' ); ?></td>
								</tr>
								<tr>
