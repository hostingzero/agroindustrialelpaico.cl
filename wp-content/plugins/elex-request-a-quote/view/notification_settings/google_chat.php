						...
						<div class="row mb-3">
							<div class=" col-lg-5 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center">
									...
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Enable to receive Google Chat notification when the customer makes a quote request.">
							...
							<div class="row mb-3 align-items-center">
								<div class=" col-lg-5 col-md-6 ">
									<div class="d-flex justify-content-between align-items-center gap-2">
										...
										<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Enter the Google Chat Webhook URL. You can find this URL on your google chat window.">
