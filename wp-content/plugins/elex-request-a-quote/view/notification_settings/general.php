				...
				<div class="row mb-3 align-items-center">
					<div class="col-lg-5 col-md-6">
						<div class="d-flex justify-content-between align-items-center">
							...
							<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Enter the email addresses to receive a notification when the customer places a quote request. By default, the administrator email id is taken to get a notification. Multiple email ids should be separated by commas.">
				...
				<div class="row mb-3 align-items-center">
					<div class="col-lg-5 col-md-6">
						<div class="d-flex justify-content-between align-items-center">
							...
							<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Select the order statuses for which customers should receive an email notification.">
				...
				<div class="row mb-3 align-items-center">
					<div class="col-lg-5 col-md-6">
						...
						<h6 class="mb-0"><?php esc_html_e( 'Debug Log', 'elex-request-a-quote' ); ?></h6>
							<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Find email, sms and google chat logs here (wp-content\uploads\wc-logs).">
								<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26">
									<g id="tt" transform="translate(-384 -226)">
										<g id="Ellipse_1" data-name="Ellipse 1" transform="translate(384 226)" fill="#f5f5f5" stroke="#000" stroke-width="1">
											<circle cx="13" cy="13" r="13" stroke="none" />
