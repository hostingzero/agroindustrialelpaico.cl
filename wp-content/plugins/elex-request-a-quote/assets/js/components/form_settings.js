            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <div class="row align-items-center mb-3">
                        <div class="col-lg-4 col-md-6">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="mb-0">{__('Show Request a Quote Form','elex-request-a-quote')}</h6>
                        ...
                        <div class="col-lg-5 col-md-6">
                            ...
                            <div>
                                <small class="text-secondary">{__('Turn this Off, if you want to use any third party form to get the quote requests.','elex-request-a-quote')}
                    ...
                    <div className="row align-items-center mb-3">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <input name="title" onChange={(e) => setTitle(e.target.value)} type="text" value={Title} className="form-control" placeholder={__('Fill Your Details' , 'elex-request-a-quote')} />
                        </div>
                    </div>
                    ...
                    <div className="row align-items-center mb-3">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <input type="text" name="success_message" onChange={(e) => setSuccessMsg(e.target.value)} value={msg} className="form-control" placeholder={__('Your request has been sent successfully.','elex-request-a-quote')} />
                        </div>
                    </div>
                </div>
            </div>
